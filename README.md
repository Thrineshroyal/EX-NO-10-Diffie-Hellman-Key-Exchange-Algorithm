...
int main() {
    ...
    printf("Enter the private key for Kumar (a): ");
    scanf("%lld", &a);
    x = mod_exp(G, a, P); 


    printf("Enter the private key for Teja (b): ");
    scanf("%lld", &b);
    y = mod_exp(G, b, P);
...
```
## Output:
![Screenshot 2025-05-25 125105](https://github.com/user-attachments/assets/c099ec82-115f-4558-bbff-142614d79f9d)
